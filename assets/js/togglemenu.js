...
(function($) {
 ...
 var arrLang = {
  ...
  'chottolan35' : 'So ChottoItsAnime Started off in 2012-2013 due to the every so growing love for animes, games and just and overal enjoymnet into the culture of it all. With Anime you learn so much, you hear so less about what it can offer but instead you sometime pick up nagative sides of it and never the positive. So This webiste is here, To offer you the user to ee whats its all about, watch what we enjoy and just to be apart of it all. EVEN IF ITS JUST FOR A MOMENT.!!'
  },
  ...
  'chottolan35' : 'ChottoItsAnimeは2012年から2013年にかけて、アニメ、ゲーム、そしてただの それのすべての文化への過度の楽しみ。アニメでは、あまりにも多くのことを学ぶことができますが、それが提供できるものについてはあまり聞こえませんが、時にはそれを否定することもあります。だから、このウェブサイトはここにあります。ユーザーにすべてのことを見て、楽しんでいるものを見て、それだけのことを見てください。ちょっとした疲れがあっても！ Youtubeはそれが始まった場所です。この間、youtubeは既に世界でも有​​数のデジタル・プラットフォームとして利用されていました。あなたが楽しんでいることをよく見直し、宣伝して怒らせる場所。これは私たちのYouTubeチャンネルでも見ることができるので、'
 },
  ...
  'chottolan35' : 'Así que ChottoItsAnime comenzó en 2012-2013 debido al amor cada vez mayor por los animes, los juegos y simplemente disfrutar de la cultura de todo. Con Anime aprendes mucho, oyes mucho menos acerca de lo que puede ofrecer, pero en lugar de eso, en algún momento recoges los aspectos negativos de él y nunca lo positivo. Así que este sitio web está aquí, para ofrecerle al usuario de qué se trata, ver lo que disfrutamos y simplemente ser parte de todo. ¡¡¡AUN SI ES SOLO POR UN MOMENTO !!'
  },
...
'chottolan35' : 'Donc, ChottoItsAnime a commencé en 2012-2013 en raison de lamour grandissant pour les animes, les jeux et tout simplement profiter de la culture de tout cela. Avec Anime vous apprenez tellement, vous entendez tellement moins sur ce quil peut offrir, mais au contraire, vous prenez parfois des côtés négatifs et jamais positifs. Donc, ce webiste est ici, pour vous offrir à lutilisateur de quoi il sagit, regarder ce que nous aimons et juste être en dehors de tout cela. Même si cest juste pour un moment.'
}
